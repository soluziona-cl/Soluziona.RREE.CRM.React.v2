...
//con DataTable
const RepoEfectividadTransferencia = () => {
        ...
        <div className="row flex-nowrap">
          ...
          <main className="col ps-md-2 pt-2">
            ...
            <div className="m-xs-0 m-lg-4"> <div className="page-header pt-3">
              <h2 className="page-header col-sm-12 col-lg-3 mt-lg-0 mt-sm-2 text-black">Reporte Efectividad Transferencia</h2>
            </div>
              <hr />
              <div className="row ">
              ...
              <section className="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <div className="mt-2">
                  {mostrarGrid !== false && <ReporteTipificadasAgenteTabla flujo={9999} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} nombre={flujo} />}
                  {mostrarGrid2 !== false && <ReporteTipificadasAgenteTabla flujo={9999} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} nombre={flujo} />}
...
export default RepoEfectividadTransferencia;
