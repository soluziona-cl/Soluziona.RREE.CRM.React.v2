        ...
        <div className="row flex-nowrap">
          ...
          <main className="col ps-md-2 pt-2">
            ...
            <div className="m-xs-0 m-lg-4"> <div className="page-header pt-3">
              <h2 className="page-header col-sm-12 col-lg-3 mt-lg-0 mt-sm-2 text-black">Resumen General</h2>
            </div>
              <hr />
              <div className="row ">
                    ...
                    <div className="col-12">
                      <div className="col-sm-12 col-md-12 col-lg-12 text-center">
                        <div className="card mb-4">
                          ...
                          {mostrarGrid !== false && <ResumenGeneralInfoDiaria flujo={campana} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} />}
                          {mostrarGrid2 !== false && <ResumenGeneralInfoDiaria flujo={campana} ini={format(startdateini, "yyyyMMdd")} fin={format(startdatefin, "yyyyMMdd")} />}
                        </div>
                      </div>
                    </div>
                  </div>
