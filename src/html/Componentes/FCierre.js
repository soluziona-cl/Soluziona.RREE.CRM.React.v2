...
// buscardor
  ...
  //
    ...
    const columns = [
        {
            name: <div className="text-wrap">Id</div>,
            selector: row => row.ao ,
            center: true
        },
        {
        ...
        {
            name: <div className="text-wrap">Accion</div>,
            cell: (row) => <button onClick={() => (Detalle(row.ini,row.fin))} className="btn btn-info  mt-4">Forzar Cierre</button>,
            center: true,
            button: true,
        }
    ];
