...
function ReporteArchivo({ flujo, ini, fin }) {
    ...
    const Datos = (async () => {
        ...
        const result = await axios.post('https://app.soluziona.cl/API_v1_prod/Aporta/API_Aporta_RegistroCivil_CRM/api/Ventas_CRM/CRM/DashTrafico/Reporte_Archivos',
    ...
    const columns = [
        ...
        {
            name: <div className="text-wrap">Fecha y Hora</div>,
            selector: row => row.callLocalTime,
            center: true,
            wrap: false,
        },
        {
